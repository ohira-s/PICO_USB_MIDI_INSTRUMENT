...
・MODULA LVL01:<br/>
　指定されたモジュレーションのレベル01(LSB)が表示されています。<br/>
・MODULA LVL02:<br/>
　指定されたモジュレーションのレベル02(MSB)が表示されています。<br/>
・AFT-TOUCH ON:<br/>
　モジュレーションがかかるまでのアフタータッチの秒数が表示されています。<br/>
...
　ファイルに保存されているドラムセット（Pad1〜6に割り当てるドラム系音色群）を変更できます。<br/>
　現時点でドラムセットの定義はファイルでしかできません。<br/>
